...
function setup() {
  ...
  leftWall = new Base(100, height / 2 + 50, 590, 100, "#8d6e63", true);
  rightWall = new Base(width - 100, height / 2 + 50, 580, 100, "#8d6e63", true);

  /*bridge = new Base(15, { x: width / 2 - 400, y: height / 2 });
  jointPoint = new Base(width - 600, height / 2 + 10, 40, 20, "#8d6e63", true);*/

  bridge = new Bridge(17, { x: width / 2 - 550, y: height / 2 });
  jointPoint = new Base(width - 400, height / 2 + 10, 120, 20, "#8d6e63", true);
